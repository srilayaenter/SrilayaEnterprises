...
-- ============================================================================
-- This migration adds comprehensive backup and recovery features including:
-- 1. Backup metadata tracking
...
BEGIN
  ...
  PERFORM log_security_event(
    ...
    NULL,
    NULL,
    jsonb_build_object('backup_id', p_backup_id, 'verified', v_verified)
  );
...
DECLARE
  ...
  v_schedule record;
BEGIN
  -- Loop through active schedules and cleanup based on retention
  FOR v_schedule IN
